...
export const metadata: Metadata = {
  title: "Profectus - The Most Researched Physical Health Platform",
  ...
  icons: {
    icon: "/ProfectusTransparentLogo.png",
  },
};
    ...
    <html lang="en">
      ...
      >
        <AuthProvider>
          ...
          <footer className="py-8 text-center text-xs opacity-60">© {new Date().getFullYear()} Profectus</footer>
          </div>
        </AuthProvider>
      </body>
    </html>
